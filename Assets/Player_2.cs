...
public class PlayerAI : MonoBehaviour
{
    ...
    [SerializeField] private float attackSpeedMultiplier = 1.45f;
    [SerializeField] private float defenseSpeedMultiplier = 1.1f;

    [Header("Dificuldade adaptativa")]
    [SerializeField] private float minDifficulty = 0.85f;
    [SerializeField] private float maxDifficulty = 1.5f;
    [SerializeField] private int scoreGapRange = 3;
    [SerializeField] private float reactionJitter = 0.35f;
    ...
    void FixedUpdate()
    {
        ...
        if (reactionTimer <= 0f)
        {
            ...
            reactionTimer = reactionTime *
                Random.Range(1f - reactionJitter, 1f + reactionJitter);
        }
    ...
    {
        if (scoreManager == null || scoreGapRange <= 0)
        {
        ...
        float t = (gap + scoreGapRange) / (scoreGapRange * 2f);
    ...
    private void MoveAI()
    {
        ...
        else if (currentState == AIState.Defense)
        {
            currentSpeed *=
